...
var baseConfig = {
    ...
    plugins: [],
    resolve: {
        alias: glob_1.default.sync(path_1.default.join(projectRoot, './src/*/')),
    },
    resolveLoader: {},
    // 对体积过大的包进行提示
    performance: {
                ...
                rules: [
                    {
                        ...
                        replacement: function (source) {
                            ...
                            return ("<script>${require('raw-loader!babel-loader!" +
                                pkg +
                                "')}</script>");
                        },
                    },
                ...
                },
                {
                    ...
                    options: {
                        ...
                        configFile: babelrcPath &&
                            path_1.default.join(process.cwd(), babelrcPath),
                    },
                },
            ],
        };
        ...
        return new offline_webpack_plugin_1.default({
            ...
            beforeAddBuffer: function (source, assetPath) {
                if (assetPath.indexOf(htmlPrefix) !== -1) {
                    ...
                    source = source.replace(/(<script)/, '<script>var pack = ' +
